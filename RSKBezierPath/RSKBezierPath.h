...
//! Project version number for RSKBezierPath.
FOUNDATION_EXPORT double RSKBezierPathVersionNumber;

//! Project version string for RSKBezierPath.
FOUNDATION_EXPORT const unsigned char RSKBezierPathVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <RSKBezierPath/PublicHeader.h>
